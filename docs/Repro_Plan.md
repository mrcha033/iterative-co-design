...
* **Goal**: Reproduce the PRD targets (Latency −20%, L2 +10%p, EpT −15%) on the two representative workloads (SSM/Mamba-3B and Transformer/BERT-base).
...
* **Mamba-3B / BERT**: Solver ≤ 5 minutes per case (offline) plus several minutes for the 1000-iteration measurement loop
